...
#      and deterministic; Phase10Render.ChunkComplete accepts an
#      encoded chunk as complete).
#
# Steady-state disk use stays at ~2 chunks of PNGs (~12 GB).
#
# Usage: scripts/p10-chunk-harvester.sh [--once]
#   loops until app/RenderOutput/p10/render-done exists (touch it when
